...
class TestUiSelectorDSL:
    ...
    def test_copy(self):
        ...
        assert original == copy_selector
        assert original is not copy_selector
    ...
    def test_hash(self):
        ...
        assert hash(selector1) == hash(selector2)
        assert hash(selector1) != hash(selector3)
    ...
    def test_from_string_validation(self):
        ...
        assert isinstance(selector, UiSelector)

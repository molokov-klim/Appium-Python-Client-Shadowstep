...
class TestElementGestures:
    ...
    def test_tap(self):
        ...
        element.gestures.tap.assert_called_once_with(100, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_click(self):
        ...
        element.gestures.click.assert_called_once_with(50, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_drag(self):
        ...
        element.gestures.drag.assert_called_once_with(100, 200, 3000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_fling_up(self):
        ...
        element.gestures.fling.assert_called_once_with(3000, "up", GestureStrategy.AUTO)
        assert result == element
    ...
    def test_fling_down(self):
        ...
        element.gestures.fling.assert_called_once_with(3000, "down", GestureStrategy.AUTO)
        assert result == element
    ...
    def test_fling_left(self):
        ...
        element.gestures.fling.assert_called_once_with(3000, "left", GestureStrategy.AUTO)
        assert result == element
    ...
    def test_fling_right(self):
        ...
        element.gestures.fling.assert_called_once_with(3000, "right", GestureStrategy.AUTO)
        assert result == element
    ...
    def test_fling(self):
        ...
        element.gestures.fling.assert_called_once_with(2500, "up", GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_down(self):
        ...
        element.gestures.scroll.assert_called_once_with("down", 0.8, 2500, False, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_up(self):
        ...
        element.gestures.scroll.assert_called_once_with("up", 0.7, 2000, False, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_left(self):
        ...
        element.gestures.scroll.assert_called_once_with("left", 0.6, 1500, False, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_right(self):
        ...
        element.gestures.scroll.assert_called_once_with("right", 0.5, 1000, False, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll(self):
        ...
        element.gestures.scroll.assert_called_once_with("down", 0.7, 2000, False, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_to_bottom(self):
        ...
        element.gestures.scroll_to_bottom.assert_called_once_with(0.8, 9000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_to_top(self):
        ...
        element.gestures.scroll_to_top.assert_called_once_with(0.7, 8000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_scroll_to_element(self):
        ...
        element.gestures.scroll_to_element.assert_called_once_with(target_locator, 20, 0.7, 5000, GestureStrategy.AUTO)
    ...
    def test_zoom(self):
        ...
        element.gestures.zoom.assert_called_once_with(0.8, 3000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_unzoom(self):
        ...
        element.gestures.unzoom.assert_called_once_with(0.75, 2500, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_swipe_up(self):
        ...
        element.gestures.swipe.assert_called_once_with("up", 0.8, 6000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_swipe_down(self):
        ...
        element.gestures.swipe.assert_called_once_with("down", 0.75, 5000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_swipe_left(self):
        ...
        element.gestures.swipe.assert_called_once_with("left", 0.7, 4000, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_swipe_right(self):
        ...
        element.gestures.swipe.assert_called_once_with("right", 0.65, 3500, GestureStrategy.AUTO)
        assert result == element
    ...
    def test_swipe(self):
        ...
        element.gestures.swipe.assert_called_once_with("up", 0.75, 5000, GestureStrategy.AUTO)
        assert result == element

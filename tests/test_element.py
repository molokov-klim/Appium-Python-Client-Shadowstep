...
class TestElement:
    ...
    def test_get_element_positive(self, app: Shadowstep, stability: None,
        ...
        assert inner_element.package == "com.android.settings"  # noqa: S101
        assert inner_element.class_ == "android.widget.TextView"  # noqa: S101
        assert inner_element.resource_id == "android:id/title"  # noqa: S101
    ...
    def test_get_element_contains(self, app: Shadowstep, stability: None, android_settings_open_close: None,
        ...
        inner_element = android_settings_recycler.get_element(locator={"text": "ork & int"},
                                                              contains=True)
        assert inner_element.contains  # noqa: S101
        assert inner_element.text == "Network & internet"   # noqa: S101
    ...
    def test_get_element_repeated_search(self, app: Shadowstep, stability: None):
        ...
        assert element1 is not None  # noqa: S101
        assert element2 is not None  # noqa: S101
        assert element1.locator == element2.locator  # noqa: S101
    ...
    def test_get_elements(self, app: Shadowstep, stability: None, android_settings_open_close: None,
        ...
        for inner_element in inner_elements:
            ...
            assert isinstance(inner_element, Element)  # noqa: S101
            assert inner_element.get_attribute("resource-id") == "android:id/title"  # noqa: S101
    ...
    def test_get_sibling(self, app: Shadowstep, stability: None, android_settings_open_close: None):
        ...
        assert "Mobile, Wi‑Fi, hotspot" in sibling.get_attribute("text")  # noqa: S101
    ...
    def test_get_siblings(self, app: Shadowstep, stability: None, android_settings_open_close: None,
        ...
        assert isinstance(siblings, Generator)  # noqa: S101
        count = 0
        bounds: list[str] = []
        for sibling in siblings:
            assert isinstance(sibling, Element)  # noqa: S101
            assert sibling.get_attribute("bounds") is not None  # noqa: S101
            bounds.append(sibling.get_attribute("bounds"))
            count += 1
        bounds_unique = set(bounds)
        assert len(bounds_unique) > 3  # noqa: S101
        assert count > 0  # noqa: S101
    ...
    def test_tap_duration(self, app: Shadowstep, stability: None):
        ...
        assert phone_info_title.get_attribute("text") == "App info"  # noqa: S101
        assert phone_info_storage.get_attribute("text") == "Storage & cache"  # noqa: S101
    ...
    def test_tap_no_such_element_exception(self, app: Shadowstep, stability: None):
        try:
            ...
            assert isinstance(error, NoSuchElementException)  # noqa: S101, PT017
    ...
    def test_tap_and_move(self, app: Shadowstep, stability: None, params: Any):
        ...
        time.sleep(5)
        assert "Search apps" in target_element.get_attribute(name="text")  # noqa: S101
        assert isinstance(element, Element)  # noqa: S101
    ...
    def test_click(self, app: Shadowstep, stability: None):
        ...
        element.click()
        time.sleep(5)
        response = str(subprocess.check_output('adb shell "dumpsys window windows | grep -E \'mSurface\'"', shell=True))
        assert "com.android.dialer" in response  # noqa: S101
    ...
    def test_click_double(self, app: Shadowstep, stability: None):
        ...
        assert "some_text" in search_src_text.get_attribute("text")  # noqa: S101
    ...
    def test_drag(self, app: Shadowstep, stability: None):
        ...
        search = app.get_element(locator={"resource-id": "com.android.quicksearchbox:id/search_widget_text"})
        assert "com.android.quicksearchbox" in search.get_attribute("package")  # noqa: S101
        ...
        time.sleep(1)
        assert not messaging_1.is_visible()  # noqa: S101
        app.get_element(locator={"content-desc": "Phone"}).tap_and_move(x=100, y=500)
    ...
    def test_is_within_screen(self, app: Shadowstep, stability: None):
        ...
        assert search.is_visible() is True  # noqa: S101
        assert phone.is_visible() is True  # noqa: S101
        phone.tap()
        time.sleep(3)
        assert phone.is_visible() is False  # noqa: S101
        assert search.is_visible() is False  # noqa: S101
    ...
    def test_fling(self, app: Shadowstep, stability: None):
        ...
        time.sleep(5)
        assert "Off" in target_element.get_attribute(name="text")  # noqa: S101
        assert isinstance(element, Element)  # noqa: S101
    ...
    def test_scroll(self, app: Shadowstep, stability: None):
        ...
        time.sleep(3)
        assert "About phone" in settings_about_phone.get_attribute("text")  # noqa: S101
    ...
    def test_get_center(self, app: Shadowstep, stability: None):
        ...
        x = int((left + right) / 2)
        y = int((top + bottom) / 2)
        assert isinstance(center, tuple) and len(center) == 2  # noqa: S101
        assert center == (x, y)  # noqa: S101

    def test_get_coordinates(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        coords = el.get_coordinates()
        left, top, right, bottom = map(int, el.bounds.strip("[]").replace("][", ",").split(","))
        assert isinstance(coords, tuple) and len(coords) == 4  # noqa: S101
        assert coords == (left, top, right, bottom)

    def test_get_attribute(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert el.get_attribute("content-desc") == "Phone"  # noqa: S101
    ...
    def test_get_property(self, app: Shadowstep, stability: None):
        ...
        assert isinstance(prop, (str, bool, dict, type(None)))  # noqa: UP038, S101

    def test_get_dom_attribute(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert el.get_dom_attribute("class") == "android.widget.TextView"  # noqa: S101

    def test_is_displayed(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert isinstance(el.is_displayed(), bool)  # noqa: S101
        assert el.is_displayed()  # noqa: S101

    def test_is_selected(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert isinstance(el.is_selected(), bool)  # noqa: S101
        assert not el.is_selected()  # noqa: S101

    def test_is_enabled(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert isinstance(el.is_enabled(), bool)  # noqa: S101
        assert el.is_enabled()  # noqa: S101

    def test_is_contains(self, app: Shadowstep, stability: None):
        el = app.get_element({"resource-id": "com.android.launcher3:id/hotseat"})
        assert el.is_contains({"content-desc": "Phone"}) is True  # noqa: S101

    def test_tag_name(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert isinstance(el.tag_name, str)  # noqa: S101
        assert el.tag_name == "Phone"  # noqa: S101

    def test_text(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert isinstance(el.text, str)  # noqa: S101
        assert el.text == "Phone"  # noqa: S101
    ...
    def test_clear(self, app: Shadowstep, stability: None):
        ...
        assert el.text == "some_text"  # noqa: S101
        el.clear()
        assert el.text == ""  # noqa: S101
    ...
    def test_set_value(self, app: Shadowstep, stability: None):
        ...
        assert "test123" in el.text  # noqa: S101
        el.clear()
    ...
    def test_send_keys(self, app: Shadowstep, stability: None):
        ...
        el = app.get_element({"resource-id": "com.android.quicksearchbox:id/search_src_text"})
        el.send_keys("abc")
        assert "abc" in el.text  # noqa: S101
        el.clear()
    ...
    def test_shadow_root(self, app: Shadowstep, stability: None):
        ...
        try:
            sr = el.shadow_root
            assert sr is not None  # noqa: S101
        except Exception as e:
            assert isinstance(e, (NoSuchElementException, AttributeError))  # noqa: UP038  # noqa: S101

    @pytest.mark.skip(reason="Method is not implemented in UiAutomator2")
    def test_location_once_scrolled_into_view(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        loc = el.location_once_scrolled_into_view
        assert "x" in loc and "y" in loc  # noqa: S101

    @pytest.mark.skip(reason="Method is not implemented in UiAutomator2")
    def test_size_location_rect(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        assert "width" in el.size and "height" in el.size  # noqa: S101
        assert "x" in el.location and "y" in el.location  # noqa: S101
        assert all(k in el.rect for k in ("x", "y", "width", "height"))  # noqa: S101
    ...
    def test_screenshot_as_base64(self, app: Shadowstep, stability: None):
        ...
        assert isinstance(ss, str)  # noqa: S101

    def test_screenshot_as_png(self, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        ss = el.screenshot_as_png
        assert isinstance(ss, bytes)  # noqa: S101

    def test_save_screenshot(self, tmp_path: Any, app: Shadowstep, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        filepath = tmp_path / "test_element.png"
        assert el.save_screenshot(str(filepath)) is True  # noqa: S101
        assert filepath.exists()  # noqa: S101
        filepath.unlink()
        assert not filepath.exists()  # noqa: S101
    ...
    def test_get_cousin(self, app: Shadowstep, stability: None, android_settings_open_close: None):
        ...
        assert switcher.get_attribute("class") == "android.widget.Switch"  # noqa: S101

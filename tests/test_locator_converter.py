...
def test_dict_to_xpath(test_data: dict[str, str]):
...
def test_xpath_to_dict(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
...
def test_uiselector_to_dict(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_to_dict(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_dict_to_uiselector(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_to_uiselector(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_to_xpath(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_dict_to_xpath_to_dict_childselector_roundtrip(test_data: dict[str, str]):
    logger.info(f"{get_current_func_name()}")
    data = test_data["data"]
    expected_result = test_data["expected_result"]
...
def test_dict_to_xpath_from_parent(test_data: dict[str, str]):
    data = test_data["data"]
...
def test_complex_locator_cases(test_data: dict[str, str]):

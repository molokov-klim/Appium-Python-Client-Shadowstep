...
from conftest import APPIUM_IP, APPIUM_PORT, UDID
...
try:
    ...
    translator = YandexTranslate(folder_id="b1ghf7n3imfg7foodstv")  # optional, if your language is not Eng
    # must contains public method: translate(self, text: str) -> str:

...
class PageInternet(PageBaseShadowstep):
    ...
    def edges(self) -> dict[str, Any]:
        return {"PageNetworkInternet": self.to_back, "PageSavedNetworks": self.to_saved_networks}
    ...
    @log_info()
    def to_saved_networks(self):
        self.saved_networks.tap()
        return self.shadowstep.get_page("PageSavedNetworks")
    ...
    def fix_connectivity(self) -> Element:
        return self.recycler.scroll_to_element(
            {"content-desc": "Fix connectivity", "class": "android.widget.Button"}
        )
    ...
    def wi_fi(self) -> Element:
        return self.recycler.scroll_to_element(
            {"text": "Wi-Fi", "resource-id": "android:id/title", "class": "android.widget.TextView"}
        )
    ...
    def t_mobile_summary(self) -> Element:
        return self.t_mobile.get_sibling({"resource-id": "android:id/summary"})
    ...
    def network_preferences_summary(self) -> Element:
        return self.network_preferences.get_sibling({"resource-id": "android:id/summary"})
    ...
    def saved_networks_summary(self) -> Element:
        return self.saved_networks.get_sibling({"resource-id": "android:id/summary"})
    ...
    def non_carrier_data_usage_summary(self) -> Element:
        return self.non_carrier_data_usage.get_sibling({"resource-id": "android:id/summary"})

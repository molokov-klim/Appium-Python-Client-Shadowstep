# ruff: noqa
# pyright: ignore
"""Test module for element waiting functionality with custom parameters.
...
class TestElementWaitingPart2:
    """Collection of waiting tests using custom parameters."""

    def test_wait_for_not_clickable_success(
        self, app: Shadowstep, android_settings_open_close: Any
    ):
        """Test successfully waiting for an element to become non-clickable."""
    ...
    def test_wait_with_custom_timeout_and_poll_frequency(
        ...
        """Test ``wait`` with custom timeout and poll frequency."""
    ...
    def test_wait_with_none_locator(self, app: Shadowstep, android_settings_open_close: Any):
        """Test ``wait`` behavior with a generic locator."""
    ...
    def test_wait_visible_with_none_locator(
        ...
        """Test ``wait_visible`` behavior with a generic locator."""

...
class TestElementQuality:
    ...
    def test_element_base_initialization(self):
        ...
        assert element_base.timeout == 30.0
        assert element_base.poll_frequency == 0.5
    ...
    def test_element_initialization(self):
        ...
        assert element.base == mock_base
        assert element.timeout == 30.0
        assert element.poll_frequency == 0.5
        assert element.contains is False
    ...
    def test_handle_dict_locator_with_class(self):
        ...
        assert result == ("xpath", "//Button[@class='Button'][@text='Click me']")
    ...
    def test_handle_dict_locator_without_class(self):
        ...
        assert result == ("xpath", "//*[@text='Click me'][@resource-id='button1']")
    ...
    def test_handle_dict_locator_with_contains(self):
        ...
        assert result == ("xpath", "//Button[contains(@class, 'Button')][contains(@text, 'Click me')]")
    ...
    def test_conditions_visible(self):
        ...
        assert callable(condition)  # pyright: ignore [reportUnknownArgumentType]
    ...
    def test_element_repr(self):
        ...
        assert "Element(locator=('xpath', '//test')" in repr_str
    ...
    def test_general_element_exception(self):
        ...
        assert exception.screen == "screenshot.png"
        assert exception.stacktrace == ["trace1", "trace2"]
...
class TestElementTypeAnnotations:
    ...
    def test_element_type_annotations(self):
        ...
        assert 'locator' in annotations
        assert 'base' in annotations
        assert 'timeout' in annotations
        assert 'poll_frequency' in annotations
        assert 'ignored_exceptions' in annotations
        assert 'contains' in annotations
        assert 'native' in annotations
    ...
    def test_conditions_type_annotations(self):
        ...
        assert hasattr(visible, '__annotations__')
        assert hasattr(not_visible, '__annotations__')
        assert hasattr(clickable, '__annotations__')
        assert hasattr(not_clickable, '__annotations__')
        assert hasattr(present, '__annotations__')
        assert hasattr(not_present, '__annotations__')

...
from shadowstep.exceptions.shadowstep_exceptions import ShadowstepNoSuchElementError
...
class TestElement:
    ...
    def test_is_within_screen(self, app: Shadowstep, press_home: Any, stability: None):
    ...
    @pytest.mark.skip(reason="Method is not implemented in UiAutomator2")
    def test_shadow_root(self, app: Shadowstep, press_home: Any, stability: None):
        el = app.get_element({"content-desc": "Phone"})
        try:
            sr = el.shadow_root
